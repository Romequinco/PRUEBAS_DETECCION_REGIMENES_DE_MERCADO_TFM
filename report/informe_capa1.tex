...
figuras \code{synth_*.png} (scorecard e IC de cobertura) desde \code{results/metrics_master.csv}
con \code{python scripts/figs_pdf/build_synthesis_figs.py}; las \code{eda_*.png} provienen del
an\'alisis exploratorio. Las m\'etricas de comportamiento y de ajuste son id\'enticas a la
versi\'on previa: esta revisi\'on solo \textbf{a\~nade} dos m\'etricas ---silueta de reg\'imenes
e intervalos de cobertura por \emph{bootstrap}--- sin re-tunear ning\'un detector ni alterar
ninguna cifra anterior.
